# RustFS S3 Storage - EU Cluster

## Overview

RustFS S3-compatible object storage deployed on the EU (Europe) cluster.

## Access URLs

| Service | URL |
|---------|-----|
| S3 API | https://rustfs.eu.canhnv.com |
| Web Console | https://rustfs-console.eu.canhnv.com |
...
```bash
# List buckets
aws s3 ls --endpoint-url https://rustfs.eu.canhnv.com --profile rustfs-eu

# Create bucket
aws s3 mb s3://my-bucket --endpoint-url https://rustfs.eu.canhnv.com --profile rustfs-eu

# Upload file
aws s3 cp ./file.txt s3://my-bucket/ --endpoint-url https://rustfs.eu.canhnv.com --profile rustfs-eu

# Download file
aws s3 cp s3://my-bucket/file.txt ./downloaded.txt --endpoint-url https://rustfs.eu.canhnv.com --profile rustfs-eu
```
...
s3 = boto3.client(
    's3',
    endpoint_url='https://rustfs.eu.canhnv.com',
    aws_access_key_id='rustfsadmin',
...
curl -I https://rustfs.eu.canhnv.com

# Test Console (should return 200)
curl -I https://rustfs-console.eu.canhnv.com
```
