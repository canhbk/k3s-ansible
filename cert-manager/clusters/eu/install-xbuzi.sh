...
# Install xbuzi.com ClusterIssuer for eu cluster
set -e

echo "Installing xbuzi.com ClusterIssuer for eu cluster..."
...
echo "xbuzi.com ClusterIssuer installed successfully on eu cluster!"