...
# Install xbuzi.com ClusterIssuer for vn cluster
set -e

echo "Installing xbuzi.com ClusterIssuer for vn cluster..."

# Switch to vn cluster context
...
echo "xbuzi.com ClusterIssuer installed successfully on vn cluster!"
