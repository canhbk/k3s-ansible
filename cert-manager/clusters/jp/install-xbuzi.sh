...
# Install xbuzi.com ClusterIssuer for jp cluster
set -e

echo "Installing xbuzi.com ClusterIssuer for jp cluster..."

# Switch to jp cluster context
...
echo "xbuzi.com ClusterIssuer installed successfully on jp cluster!"
