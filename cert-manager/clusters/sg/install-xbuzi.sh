...
# Install xbuzi.com ClusterIssuer for sg cluster
set -e

echo "Installing xbuzi.com ClusterIssuer for sg cluster..."

# Switch to sg cluster context
...
echo "xbuzi.com ClusterIssuer installed successfully on sg cluster!"
