...
SA_NAME="ai-prod-log-reader"
NAMESPACE="ai-prod-log-access"
TARGET_NAMESPACE="nsp-prod-murror-ai"
...
echo "✅ kubeconfig generated: $OUTPUT_FILE (default namespace: $TARGET_NAMESPACE)"
